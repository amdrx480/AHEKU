...
func (cl *ControllerList) RegisterRoutes(e *echo.Echo) {
	...
	items := e.Group("items")
	items.GET("/:id", cl.AdminController.ItemsGetByID)
	items.POST("", cl.AdminController.ItemsCreate)
	items.GET("", cl.AdminController.ItemsGetAll)
	items.DELETE("/:id", cl.AdminController.ItemsDelete)
